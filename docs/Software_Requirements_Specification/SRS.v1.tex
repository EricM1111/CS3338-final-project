...
\title{Scientific Forgery Image Detection\\SRS Document}
...
\begin{longtable}{|p{2cm}|p{2.5cm}|p{5cm}|p{4cm}|}
\hline
\textbf{Version} & \textbf{Date} & \textbf{Description} & \textbf{Authors} \\
\hline
1.0 & May 8, 2026 & Initial SRS created for Snapshot 1 & Janelle Rivera, Eric Marroquin, Alexis Flores \\
\hline
\end{longtable}
